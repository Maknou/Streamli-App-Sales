...
## drop any na left in the data
    ...
    c01, c01a,c01b= st.columns([2,6,2])
    with c01a:
    ...
    if genre == 'Main':
        ...
        st.write('In order to start reviewing your reports, please select from the above list which section you want to review. You can use the filters provided on the left to filter your data via **Year** and via **Market**')
        ...
        st.write('You are reviewing the orders delivery status')
